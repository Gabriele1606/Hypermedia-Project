...
--
-- Host: 127.0.0.1
-- Creato il: Giu 23, 2016 alle 23:11
...
INSERT INTO `assistanceservices` (`id`, `categoria`, `tipo`, `nome`, `intro`, `immagine`, `descrizione`, `contenuto`) VALUES
...
(1, 'assistenzaTecnica', 'devices', 'Mail', ' <div class="product-card wow fadeInUp animated"><div class="product-image"><i class="fa fa-envelope" aria-hidden="true"></i></div><div class="product-info"><h5>Mail</h5><h6>Configura la Webmail direttamente dal tuo device</h6></div></div>', NULL, NULL, NULL),
(2, 'assistenzaTecnica', 'adslefibra', 'ADSL e Fibra', '<div class="product-card wow fadeInUp animated"><div class="product-image"><i class="fa fa-laptop" aria-hidden="true"></i></div><div class="product-info"><h5>ADSL &amp; Fibra</h5><h6>Richiedi una verifica sulla tua linea telefonica in caso di guasti</h6></div></div>', NULL, NULL, NULL),
(3, 'assistenzaTecnica', 'decoder', 'Decoder & Tv', '<div class="product-card wow fadeInUp animated"><div class="product-image"><i class="fa fa-television" aria-hidden="true"></i></div><div class="product-info"><h5>Decoder &amp; TV</h5><h6>Risolvi eventuali problemi di visione contenuti</h6></div></div>', NULL, NULL, NULL),
(4, 'assistenzaTecnica', 'alls', 'Navigazione', ' <div class="product-card wow fadeInUp animated"><div class="product-image"><i class="fa fa-paper-plane" aria-hidden="true"></i></div><div class="product-info"><h5>Navigazione</h5><h6>Problemi di navigazione? Controlla le impostazioni di rete</h6></div></div>', NULL, NULL, NULL),
(5, 'assistenzaTecnica', 'navigazione', 'Sicurezza PC', ' <div class="product-card wow fadeInUp animated"><div class="product-image"><i class="fa fa-user-plus" aria-hidden="true"></i></div><div class="product-info"><h5>Sicurezza PC</h5><h6>Software e tricks per una navigazione sicura</h6></div></div>', NULL, NULL, NULL),
...
(7, 'lineManagement', 'alls', 'Intervento', '<div class="product-card wow fadeInUp animated"><center><div class="product-image"><i class="fa fa-cog" aria-hidden="true"></i>\r\n</div></center><div class="product-info"><h5>Intervento</h5><h6>Richiedi l''intervento di un tecnico specializzato TIM</h6></div></div>', NULL, NULL, NULL),
(8, 'lineManagement', 'devices', 'Ricaricabile', '<div class="product-card wow fadeInUp animated"><center><div class="product-image"><i class="fa fa-mobile" aria-hidden="true"></i>\r\n</div></center><div class="product-info"><h5>Ricaricabile</h5><h6>Gestisci i dati relativi alla tua sim TIM</h6></div></div>', NULL, NULL, NULL),
(9, 'lineManagement', 'adslefibra', 'Decoder & TV', '<div class="product-card wow fadeInUp animated"><center><div class="product-image"><i class="fa fa-plug" aria-hidden="true"></i>\r\n</div></center><div class="product-info"><h5>Decoder &amp; TV</h5><h6>Scopri come collegare pi&uacute; dispositivi sul tuo router TIM</h6></div></div>', NULL, NULL, NULL),
(10, 'promotions', 'devices', 'Estensione Garanzia', '<div class="product-card wow fadeInUp animated"><center><div class="product-image"><img src="images/assistanceservices/promo1.png" class="img-responsive">\r\n</div></center><div class="product-info"><h5>Estensione della Garanzia</h5><h6>Sei cliente TIM da pi&uacute; di due anni e hai appena acquistato un nuovo device? TIM ti premia regalandoti 6 mesi di garanzia in pi&uacute;!</h6></div></div>', NULL, NULL, NULL),
(11, 'promotions', 'adslefibra', 'Passaggio a Fibra', '<div class="product-card wow fadeInUp animated"><center><div class="product-image"><img src="images/assistanceservices/promo2.png" class="img-responsive">\r\n</div></center><div class="product-info"><h5>Passaggio a Fibra</h5><h6>Hai un modem ADSL a 7mb/s ma vorresti navigare pi&uacute; velocemente? Se acquisti un nuovo modem online, TIM ti offre la configurazione gratuita!</h6></div></div>', NULL, NULL, NULL);
